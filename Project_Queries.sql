...
/* 3rd Insight Continued; This Query provides the data set for the 3rd visualization. It helps to demonstrate all of the TV Shows' individual revenue as opposed to only the overall average. I made it a subquery because I thought all information needed to be in one query. */
